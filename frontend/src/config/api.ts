...
const getDevApiUrl = () => {
  ...
  const fallbackUrl = Platform.select({
    ios: 'http://192.168.0.4:5000', // Tu IP actual (SIN /api)
    android: 'http://192.168.0.4:5000', // Misma IP para dispositivo físico (SIN /api)
    default: 'http://192.168.0.4:5000' // Usar IP local en lugar de localhost
  });
...
const PROD_API_URL = 'http://TU-IP-PUBLICA:5000'; // Cambiar por tu IP pública o dominio
