...
const Transacciones: React.FC<TransaccionesProps> = ({ onAuthChange }) => {
  ...
  const loadTransacciones = async () => {
    try {
      ...
      setTimeout(() => {
        setTransacciones([
          { id: 1, nombre: 'Salario Mensual', categoria: 'Salario', monto: 2800.00, fecha: '2025-08-10', tipo: 'ingreso', descripcion: 'Salario del mes de agosto' },
          { id: 2, nombre: 'Supermercado Walmart', categoria: 'Alimentación', monto: -85.50, fecha: '2025-08-12', tipo: 'gasto', descripcion: 'Compras semanales' },
          { id: 3, nombre: 'Uber', categoria: 'Transporte', monto: -15.00, fecha: '2025-08-12', tipo: 'gasto', descripcion: 'Viaje al centro comercial' },
          { id: 4, nombre: 'Freelance Diseño', categoria: 'Freelance', monto: 450.00, fecha: '2025-08-11', tipo: 'ingreso', descripcion: 'Diseño de logo para cliente' },
          { id: 5, nombre: 'Netflix', categoria: 'Entretenimiento', monto: -15.99, fecha: '2025-08-10', tipo: 'gasto', descripcion: 'Suscripción mensual' },
          { id: 6, nombre: 'Gasolina', categoria: 'Transporte', monto: -60.00, fecha: '2025-08-09', tipo: 'gasto', descripcion: 'Tanque lleno' },
        ]);
        setLoading(false);
      }, 1000);
    } catch (error) {
